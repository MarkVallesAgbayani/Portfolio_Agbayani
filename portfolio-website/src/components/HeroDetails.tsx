function HeroDetails() {
  return (
    <div className="intro-hero mx-auto flex w-full max-w-4xl flex-col px-1 text-center sm:px-4">
      ...
      <p className="mx-auto mt-4 max-w-xl text-sm tracking-wide text-neutral-500 sm:text-base">
        Experienced in building modern, responsive websites with a focus on
        intuitive user experience and clean, functional design.
      </p>
    </div>
  );
}
